...
def get_video_data():
    ...
    vid_data = []  # [{video 1 data}, {video 2 data}, {video 3 data}]
...
def print_data(data):
    for entry in data:
        pprint.pprint(entry)   # pprint.pprint(['views'])
...
if __name__ == '__main__':     # whenever call video.py, this section actually runs it not the top.
